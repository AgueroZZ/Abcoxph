...
#'
#' @return A list that contains all the information needed for your prior to be fitted using abcoxph_fit.
#'
...
#' @param prior_control A list specifies your prior distributions get from prior_setup_AGHQ.
